...
<body>
	<div id="datagrid_toolbar">
		...
		<a href="javascript:searchStudent()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
			&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/insurance/daochucqwrl"    class="btn btn-info btn-sm"><span class="glyphicon glyphicon-plus"></span>导出EXCEL</a>
		${sessionScope.powLow}
...
/* 			op_fmt : function(value, row, index) {
		...
		$("#datagrid_person").datagrid({
			...
			iconCls : "icon-man",
			height : 500,
			url : '${pageContext.request.contextPath}/insurance/showAll2',//自动请求url，自动创建tr，装在数据.
