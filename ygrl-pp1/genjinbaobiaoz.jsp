...
<body>
	<div id="datagrid_toolbar">
		...
		<a href="javascript:searchStudent()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
			&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/genjin/baobiaodaochu1"    class="btn btn-info btn-sm"><span class="glyphicon glyphicon-plus"></span>导出</a>
		${sessionScope.powLow}
...
<th data-options="field:'mingcheng',width:30">名称</th>
		
	<th data-options="field:'kgjlxbs',width:30">可跟进联系不上</th>
	<th data-options="field:'kgjlxs',width:30">可跟进正常联系</th>
	
	<th data-options="field:'kgjlxs',width:30">不可跟进联系不上</th>
	<th data-options="field:'bkgjlxbs',width:30">不可跟进正常联系</th>
	
	<th data-options="field:'bkgjlxs',width:30">结束数量联系不上</th>
	<th data-options="field:'jslxbs',width:30">结束数量正常联系</th>
	
	<th data-options="field:'jslxs',width:30">未结束联系不上</th>
	<th data-options="field:'wjslxbs',width:30">未结束正常联系</th>
...
/* 			op_fmt : function(value, row, index) {
		...
		$("#datagrid_person").datagrid({
			...
			iconCls : "icon-man",
			height : 500,
			url : '${pageContext.request.contextPath}/genjin/showAllgenjinz',//自动请求url，自动创建tr，装在数据.
