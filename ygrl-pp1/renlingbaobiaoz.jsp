...
<body>
	...
	<table id="datagrid_person">
		...
		<th data-options="field:'bianhao',width:100">工号</th>	
	<th data-options="field:'mingchneg',width:100">坐席名</th>
...
/* 			op_fmt : function(value, row, index) {
		...
		$("#datagrid_person").datagrid({
			...
			iconCls : "icon-man",
			height : 500,
			url : '${pageContext.request.contextPath}/chongsheng/showAll7',//自动请求url，自动创建tr，装在数据.
