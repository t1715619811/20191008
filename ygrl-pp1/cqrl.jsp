...
<body>
	<div id="datagrid_toolbar">
		...
		<a href="javascript:searchStudent()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/insurance/daochucqrl"    class="btn btn-info btn-sm"><span class="glyphicon glyphicon-plus"></span>导出EXCEL</a>
	...
	<table id="datagrid_person">
		<thead>
			...
			<th data-options="field:'inputdate',width:30">导入日期</th>
			...
			<th data-options="field:'enddate',width:30">终保日期</th>	
...
/* 			op_fmt : function(value, row, index) {
		...
		$("#datagrid_person").datagrid({
			...
			iconCls : "icon-man",
			height : 500,
			url : '${pageContext.request.contextPath}/insurance/showAll3',//自动请求url，自动创建tr，装在数据.
