...
<th data-options="field:'mingcheng',width:10">名称</th>
		
	<th data-options="field:'kgjlxbs',width:10">可跟进联系不上</th>
	<th data-options="field:'kgjlxs',width:10">可跟进正常联系</th>
	
	<th data-options="field:'kgjlxs',width:10">不可跟进联系不上</th>
...
/* 			op_fmt : function(value, row, index) {
		...
		$("#datagrid_person").datagrid({
			...
			iconCls : "icon-man",
			height : 500,
			url : '${pageContext.request.contextPath}/genjin/showAllgenjinq',//自动请求url，自动创建tr，装在数据.
