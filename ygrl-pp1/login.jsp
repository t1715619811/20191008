		...
		<div class="login">
			<form id="loginForm" method="post" >
				<table >
					...
					<td><span style="font-size:20px;color:green;" >客户认领及预约程序</span></td>
					</tr>
						<tr>
					  ...
					  <tr>
							...
							<td>
								<input class="easyui-validatebox" type="password" maxlength="22" name="password" data-options="required:true,validType:'maxLength[6]'" id="password">
							</td>
					  </tr>
					...
					<tr>
						...
						<th>&nbsp;</th>
						<td>
							<input type="button" class="homeButton"><input id="login" type="button" class="loginButton" data-options="iconCls:'icon-man'" value="登录">
						</td>
						...
						<div class="btn-group">
					<a href="${pageContext.request.contextPath }/regist.jsp" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-plus"></span>注册</a>
...
var param="username="+name+"&password="+pwd+"&enCode="+enCode;
					...
					location.href="${pageContext.request.contextPath}/ppp.jsp";
